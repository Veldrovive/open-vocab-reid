...
from .duke_mtmc_video_ds import DukeMTMCVideoDataset, DukeSplit
...
from .vrai_ds import VRAIDataset, VRAISplit
from .veri_video_ds import VeRiVideoDataset, VeRiSplit
